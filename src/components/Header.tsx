    ...
    <>
      ...
      <div className="bg-[#2b1b12] text-[#f3ead7] text-xs py-1.5 px-4 tracking-wide flex justify-between items-center max-w-full">
        <div className="hidden sm:flex items-center gap-3">
          <a href="https://www.instagram.com/konkanfoodbazar/" target="_blank" rel="noopener noreferrer" className="hover:text-[#c77b1f] transition-colors flex items-center gap-1.5" aria-label="Instagram">
        ...
        <div className="hidden sm:flex items-center">
          <a href="tel:+919876543210" className="flex items-center gap-1.5 hover:text-[#c77b1f] transition-colors bg-[#c77b1f]/20 px-3 py-0.5 rounded-full border border-[#c77b1f]/30">

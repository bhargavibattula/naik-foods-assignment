        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.facebook.com/naiknaikfoods_/" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#5a4636]/30 rounded-lg hover:bg-[#c77b1f]/30 transition-colors" aria-label="Facebook">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/naikfoods_/" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#5a4636]/30 rounded-lg hover:bg-[#c77b1f]/30 transition-colors" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://www.naikfoods.co.in/pages/contact" className="text-sm text-[#a89580] hover:text-[#c77b1f] transition-colors">Contact Us</a></li>
              <li><a href="https://www.naikfoods.co.in/policies/refund-policy" className="text-sm text-[#a89580] hover:text-[#c77b1f] transition-colors">Refund Policy</a></li>
              <li><a href="https://www.naikfoods.co.in/policies/privacy-policy" className="text-sm text-[#a89580] hover:text-[#c77b1f] transition-colors">Privacy Policy</a></li>
              <li><a href="https://www.naikfoods.co.in/policies/terms-of-service" className="text-sm text-[#a89580] hover:text-[#c77b1f] transition-colors">Terms of Service</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[#a89580]">
              ...
              <li className="flex items-center gap-2">
                <span>🌐</span>
                <a href="https://www.naikfoods.co.in" target="_blank" rel="noopener noreferrer" className="hover:text-[#c77b1f] transition-colors">
                  www.naikfoods.co.in
                </a>
              </li>
            </ul>
